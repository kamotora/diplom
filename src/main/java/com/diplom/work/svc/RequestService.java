...
public class RequestService {
     ...
     * */
    public ResponseEntity<String> postRequest(@NonNull final String method_name, @NonNull final String body) throws SettingsNotFound, JsonProcessingException, RestClientException {
